...
output_file = '/home/tbai4/llama3/dumps/prisoners/prisoners_baseline_train_large.jsonl'
    ...
    for seed in tqdm(range(500)):
        try:
            result = prisoners_baseline(
                ...
                seed=seed+500, # can't overlap with the eval set
                temperature=1.0,
                top_p=1.0,
            )
            ...
            torch.save(sample, f'/home/tbai4/llama3/dumps/prisoners/prisoners_data/trace_{strategy}_{seed}.pt')
