...
def process_strategy(strategy=None):
    CKPT_PATH = {
        None: '/scratch4/jeisner1/tjbai/checkpoints/prisoners/baseline/lora_epoch-1_step-155.pt',
        'always_cooperate': '/scratch4/jeisner1/tjbai/checkpoints/prisoners/always_cooperate/lora_epoch-0_step-195.pt',
        'always_defect': '/scratch4/jeisner1/tjbai/checkpoints/prisoners/always_defect/lora_epoch-0_step-95.pt',
    }
    ...
    workflow.model.eval()
    load_ckpt(workflow, CKPT_PATH[strategy])

    payoff = (5, 3, 1, 0)
    output_file = '/home/tbai4/llama3/dumps/prisoners/prisoners_cached_paired_predict_post.jsonl'
